...
export type UserProfile = { id: number; email: string; name: string; avatar?: string | null; phone?: string | null; address?: string | null; facebookUrl?: string | null; age?: number | null; gender?: string | null; occupation?: string | null }
...
export async function updateProfile(
  token: string,
  data: { name?: string; avatar?: string | null; phone?: string | null; address?: string | null; facebookUrl?: string | null; age?: number | null; gender?: string | null; occupation?: string | null },
