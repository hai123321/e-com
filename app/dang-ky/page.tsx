...
export default function RegisterPage() {
  ...
  const fields = [
    { key: 'name',     label: t.auth.nameLabel,            type: 'text',     placeholder: t.auth.namePlaceholder },
    { key: 'email',    label: 'Email',                     type: 'email',    placeholder: 'your@email.com' },
    { key: 'password', label: t.auth.passwordLabel,        type: 'password', placeholder: '••••••••' },
    { key: 'confirm',  label: t.auth.confirmPasswordLabel, type: 'password', placeholder: '••••••••' },
  ]
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">{t.auth.registerWelcome}</p>
          </div>
