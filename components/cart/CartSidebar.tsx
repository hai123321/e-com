...
export function CartSidebar() {
  ...
  function handleCheckout() {
    addToast('Chức năng thanh toán đang được phát triển!', 'info')
    closeCart()
  }
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full gap-4 text-gray-400">
              ...
              <p className="text-sm text-center">Hãy thêm sản phẩm vào giỏ hàng</p>
              <button
                onClick={closeCart}
        ...
        {items.length > 0 && (
          <div className="shrink-0 border-t border-gray-100 p-5 bg-gray-50 space-y-3">
            <div className="flex justify-between text-sm text-gray-500">
              <span>Số lượng</span>
              <span className="font-semibold text-gray-700">{totalItems()} sản phẩm</span>
            </div>
