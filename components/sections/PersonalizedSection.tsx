...
export function PersonalizedSection() {
  ...
  // No profile: always show the prompt (stable, no flash)
  if (!hasProfile) {
    return (
  ...
  // Has profile but products not ready yet: invisible sentinel for IntersectionObserver.
  // No skeleton shown — section only appears once we have real results (no flash/disappear).
  if (!products.length) {
    return <div ref={sectionRef} aria-hidden="true" />
  }

  // Products loaded — render the full section (fade in)
  return (
    <section ref={sectionRef} className="py-12 lg:py-20 bg-gradient-to-b from-purple-50 to-white animate-fade-in">
      <div className="section-container">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 lg:mb-8">
          <div>
            <div className="section-label">
